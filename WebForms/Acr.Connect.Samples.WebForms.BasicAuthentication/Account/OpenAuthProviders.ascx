<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="Acr.Connect.Samples.WebForms.BasicAuthentication.Account.OpenAuthProviders" %>
